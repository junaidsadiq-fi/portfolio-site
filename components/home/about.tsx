...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am a passionate Full Stack Developer who builds robust and scalable
        applications.
      </span>
      <span
      ...
      >
        I take responsibility for both frontend and backend development,
        ensuring seamless user experiences and efficient system operations.
      </span>
    </h1>
  );
